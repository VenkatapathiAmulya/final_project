...
export class AccountService {
  ...
  //           }));
    ...
    add(userbudget:UserBudget,username: string){
      ...
      return this.http.post(`${environment.apiUrl}/add`, userbudget,{
      headers: {
        'Authorization': `Bearer ${token}`
    }}
      );
  ...
  error(message) {
    ...
    getAll(username:string) {
      ...
      console.log("********** entered getall method",username)
        return this.http.post<UserBudget[]>(`${environment.apiUrl}/getbudgetwithuser`,{username},{
          headers: {
            'Authorization': `Bearer ${token}`
        }});
    }
    ...
    getById(id: String) {
      ...
      console.log("************ entered getbyid",id);
        return this.http.post<UserBudget>(`${environment.apiUrl}/getbudgetwithid`,{id},{
          headers: {
            'Authorization': `Bearer ${token}`
        }});
    }
    ...
    update(id, params,username) {
      ...
      params.username = username;
        return this.http.put(`${environment.apiUrl}/update`, {id,params},{
          headers: {
            'Authorization': `Bearer ${token}`
        }})
    }
